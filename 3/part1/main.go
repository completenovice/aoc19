...
func getJourney(directions []string) {
	lastPoint := []int{0, 0}
	trackedPoints := [][]int{}
	for _, direction := range directions {
		trackedPoints = append(trackedPoints, getStint(lastPoint[0], lastPoint[1], direction))
		lastPoint = []int{trackedPoints[0][]}
		// I have no clue what I'm fucking doing
	}
}
